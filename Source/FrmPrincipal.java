...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    ValidarLetras validarLetras = new ValidarLetras(); //Objeto de la clase ValidarLetras
    public FrmPrincipal() {
        initComponents();
    }
    ...
    private void txtLetrasKeyTyped(java.awt.event.KeyEvent evt) {                                   
        validarLetras.soloLetras(evt); //Llamo al metodo y le paso como parametro el event
    }                                  
